...
**Phase:** COMMERCIAL-READINESS-001. Companion to [COMMERCIAL_READINESS.md](COMMERCIAL_READINESS.md) and [USER_JOURNEY.md](USER_JOURNEY.md). Documentation only. Every recommendation below is ranked by business impact, not engineering effort — a cheap fix with high trust impact outranks an expensive fix with low impact.
