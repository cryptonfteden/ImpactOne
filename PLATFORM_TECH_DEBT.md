...
**Purpose:** A ranked, standing register of the specific technical debts identified in [PLATFORM_ARCHITECTURE_REVIEW.md](PLATFORM_ARCHITECTURE_REVIEW.md) and [PLATFORM_SCALABILITY_REPORT.md](PLATFORM_SCALABILITY_REPORT.md), so future work can track and pay these down deliberately rather than rediscovering them. Ranked CRITICAL / HIGH / MEDIUM / LOW by likely future impact, not by effort to fix.
