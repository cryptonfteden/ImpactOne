...
- API contract coverage in [API_CONTRACTS.md](API_CONTRACTS.md)
- Competitive landscape synthesis in [COMPETITOR_INTELLIGENCE.md](COMPETITOR_INTELLIGENCE.md)

Observed structural gaps:

- No auth/session endpoints (already documented as missing in [API_CONTRACTS.md](API_CONTRACTS.md))
