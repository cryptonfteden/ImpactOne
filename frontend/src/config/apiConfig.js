...
const isLocalPreview = ["127.0.0.1", "localhost"].includes(browserHostname);
const localNetworkApiUrl = `http://${browserHostname}:5000/api`;
...
export const API_BASE_URL = isLocalPreview
  ...
  : import.meta.env.VITE_API_BASE_URL || localNetworkApiUrl;
