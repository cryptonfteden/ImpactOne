...
See [AGENT_SCALABILITY.md](AGENT_SCALABILITY.md) for how this architecture behaves at 50+ agents and beyond a single process, and [AGENT_BEST_PRACTICES.md](AGENT_BEST_PRACTICES.md) for the practical guide to building one new agent correctly.
