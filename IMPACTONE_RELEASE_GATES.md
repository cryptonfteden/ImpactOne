...
- Human or agent review: a reviewer independent of the author confirms the relevant Mandatory items, using [IMPACTONE_DEFINITION_OF_DONE.md](IMPACTONE_DEFINITION_OF_DONE.md) as the working checklist.
