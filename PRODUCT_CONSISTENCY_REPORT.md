...
See [PRODUCT_STYLE_GAPS.md](PRODUCT_STYLE_GAPS.md) for every inconsistency found here, ranked, and [PLATFORM_STANDARDIZATION_PLAN.md](PLATFORM_STANDARDIZATION_PLAN.md) for the prioritized plan to close them.
