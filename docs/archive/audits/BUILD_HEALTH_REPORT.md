...
See [PRODUCTION_BUILD_FIX_PLAN.md](../../operations/PRODUCTION_BUILD_FIX_PLAN.md) for the recommended remediation sequence and [TOOLING_GAPS.md](../../engineering/TOOLING_GAPS.md) for the full tooling-gap breakdown with Mandatory/Recommended/Nice-to-have framing.
