...
**Phase:** DESIGN-PERFECTION-001. Companion to [PIXEL_PERFECT_CHECKLIST.md](../../design/PIXEL_PERFECT_CHECKLIST.md). The formal design-quality recommendation, treating this exactly as the mission frames it: "pretend ImpactOne is shipping tomorrow."
