...
**Phase:** EMOTIONAL-DESIGN-001. Companion to [MARKET_MOODS.md](../product/MARKET_MOODS.md) and [WORLD_STATES.md](WORLD_STATES.md). Specifies how these 12 states are computed, how several can be real and true at once without contradicting each other, and how transitions between them are paced.
