...
- The concrete, area-by-area polish checklist (materials, glass, metal, light, reflections, gradients) → [PREMIUM_POLISH.md](../product/PREMIUM_POLISH.md).
- The literal, second-by-second first-10-seconds sequence → [FIRST_IMPRESSION.md](../product/FIRST_IMPRESSION.md).
