...
- **[MARKET_MOODS.md](../product/MARKET_MOODS.md)** — the 6 market-condition states the mission names (Calm, Bull, Bear, Panic, High Uncertainty, Major Geopolitical Events), each fully specified across the mission's 8 required dimensions.
