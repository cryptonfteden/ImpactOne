...
**Phase:** DESIGN-PERFECTION-001. Companion to [VISUAL_AUDIT.md](../archive/audits/VISUAL_AUDIT.md). Every audit finding restated as a concrete, checkable implementation task, ordered by priority.
