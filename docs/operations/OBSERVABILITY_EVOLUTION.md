...
These directly address the "what must change before 100+ agents" findings in [OBSERVABILITY_AUDIT.md](../archive/audits/OBSERVABILITY_AUDIT.md), and should be treated as a single, coordinated change rather than five separate patches, since they compound:
