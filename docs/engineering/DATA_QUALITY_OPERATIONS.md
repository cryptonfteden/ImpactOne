...
**Phase:** DATA-QUALITY-001. Companion to [DATA_QUALITY_ARCHITECTURE.md](DATA_QUALITY_ARCHITECTURE.md) and [PROVIDER_HEALTH_MODEL.md](../operations/PROVIDER_HEALTH_MODEL.md). Documentation only.
