...
**Phase:** EMOTIONAL-DESIGN-001. Companion to [EMOTIONAL_DESIGN.md](../design/EMOTIONAL_DESIGN.md). Each state below is bounded by a real, disclosed data threshold — never a fixed animation played irrespective of real conditions. All 8 required dimensions are specified per state.
