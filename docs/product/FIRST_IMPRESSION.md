...
**Phase:** CINEMATIC-EXPERIENCE-001. Companion to [CINEMATIC_GUIDELINES.md](../design/CINEMATIC_GUIDELINES.md). A literal, timed storyboard of what happens between opening the real Flagship Screen and 10 seconds later, engineered against one goal: the mission's own emotional target — *"the user should feel they entered the control room of global financial intelligence."*
