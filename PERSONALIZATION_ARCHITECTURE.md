...
**Purpose:** The target architecture Personal Intelligence should converge on before it expands further — building on the genuine strengths found in [PERSONAL_INTELLIGENCE_REVIEW.md](PERSONAL_INTELLIGENCE_REVIEW.md) and closing the gaps in [PERSONAL_INTELLIGENCE_GAPS.md](PERSONAL_INTELLIGENCE_GAPS.md). This is a description of what should exist, not a review of what does — no code was written or changed to produce it.
